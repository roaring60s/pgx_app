...
# Sample details:
# MG2600011
# /media/D1/patients/B000_mygenics/MG2600011/pgx_exome_hap_MG2600011_ST1A.txt
# /media/D1/patients/B000_mygenics/MG2600011/pgx_exome_var_MG2600011
# /media/D1/patients/B000_mygenics/MG2600011/biodata/MG2600011_biodata_master.txt
...
dir="/media/D1/patients/B000_mygenics/"
...
hap_snps_master="./annotation/pgx_asa_hap_snps_master_05.01.2024.txt"

hap_alleles_master="./ann/pgx_asa_hap_alleles_master_090225.txt"

variants_snps_master="./annotation/pgx_asa_variants_snps_master_05.01.2024.txt"

hap_genes_1C="./ann/pgx_hap_genes_1C_SRT_DD_UX.txt"

var_clin_alleles_EV13="./ann/pgx_asa_var_clin_alleles_EV13_160325.txt"

hap_clin_alleles_EV13="./ann/pgx_asa_hap_clin_alleles_EV13_160325.txt"
...
time python "$pythond/fnc_pgx_hap_alleles_1B_020425.py" "$bio_path" "$hap_alleles_master" "$dir_path"
wait
...
time python "$pythond/fnc_pgx_hap_clin_ST3_03.02.24.py" "$bio_path" "$hap_clin_alleles_EV13" "$dir_path"
wait
