                ...
                for ln1 in p1:
                    ...
                    if gene1 == gene2d6:
                        if exon9 == 2 and exon9 == intron2:
                            ...
                            if hap1[0] == "*1" and hap1[1] == "*1":
                                print(s.join(ls1), "*1X2/*5", sep=s, file=fileout)
                            elif hap1[0] == "*1" and hap1[1] != "*1":
                                print(s.join(ls1), "*5/" + hap1[1], sep=s, file=fileout)
                                print(s.join(ls1), hap1[1] + "/*5", sep=s, file=fileout)
                            elif hap1[0] != "*1":
                                print(s.join(ls1), hap1[0] + "/*5", sep=s, file=fileout)
                            ...
                            elif hap1[0] == "*10" or hap1[1] == "*10":
                                intron2_copies = str(intron2 - 2)
                                print(s.join(ls1), "*5/*36X" + intron2_copies, sep=s, file=fileout)

                        elif exon9 != intron2 and intron2 > 2:

                            # if exon9 == 0:
                            #     division = 0  # Choose your desired default value here
                            # else:
                            ...
                            if n == 0:
                                ...
                                elif hap1.count(hap10) == 0:
                                    assigned_dip0 = "(" + ls1[2] + ")X" + times
                                    print(s.join(ls1), assigned_dip0, sep=s, file=fileout)

                                elif hap1.count(hap10) == 1:
                                ...
                                elif hap1.count(hap10) == 1 and hap1[1] == hap10:
