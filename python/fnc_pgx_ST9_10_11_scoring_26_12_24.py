        ...
        for lnx in px:
            ...
            with open(path_in, "r") as p1:
                for ln1 in p1:
                    ...
                    if score_average >= 100:
                        # if "1A" in ev_ls or "2A" in ev_ls or "1B" in ev_ls:
                        # scoring until 25/12/2024
                        # if ("1A" in ev_ls and "1B" in ev_ls) or ("1A" in ev_ls and "2A" in ev_ls):
                        # scoring from 26/12/2024
                        if "*" in ls1[8] and "Tier 1 VIP" in tier_ls and ("1A" in ev_ls or "1B" in ev_ls):
                            weight3 = 3
                            # noinspection PyTypeChecker
                    ...
                    # if score_average >= 100 and "Tier 1 VIP" not in tier_ls:
                    #     weight2 = 2
                    #     # noinspection PyTypeChecker
                    #     print(s.join(ls1), weight2, sep=s, file=fileout)
                        
                    if 5 <= score_average <= 100:
                        weight2 = 2
                        # noinspection PyTypeChecker
                        print(s.join(ls1), weight2, sep=s, file=fileout)

                    # if 2 <= score_average <= 3 and "Tier 1 VIP" not in tier_ls:
                    #     weight1 = 1
                    #     # noinspection PyTypeChecker
                    #     print(s.join(ls1), weight1, sep=s, file=fileout)
                        
                    if 1.5 <= score_average < 5:
                        weight1 = 1
                        # noinspection PyTypeChecker
                        print(s.join(ls1), weight1, sep=s, file=fileout)
