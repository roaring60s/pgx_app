                ...
                for ln2 in p2:
                    ...
                    with open(path_in1, "r") as p1:
                        ...
                        for ln1 in p1:
                            ...
                            function = ls1[18]
                            drugS = ls1[14]
                            score2 = str(float(ls1[12])*gtscore)
        ...
        for lnx in px:
            ...
            with open(path_in, "r") as p1:
                for ln1 in p1:
                    ...
                    score_average = statistics.mean(score_ls)
                    gt_average = statistics.mean(gt_ls)

                    # if score_average > 30 and gt_average > 1.4:
                    #     weight3 = 3
                    #     print(s.join(ls1), weight3, sep=s, file=fileout)

                    # if score_average > 100 and (1 <= gt_average <= 1.4):
