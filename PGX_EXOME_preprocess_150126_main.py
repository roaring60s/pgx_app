...
print(f"starting grep command tp remove hashed rows for sample {sample}")
...
outfile6 = f"{sampledir}{sample}_exome_10C.vcf"
...
print(" ======================================================================== ")
print(" ")
print(f"Starting STEP 1 for sample {sample}")
print(f"Generating 10C VCF file for sample {sample}")
print(" ")

# outfile1 = f"{sampledir}{sample}_exome_12C.vcf"
generate_10C = f"cut -f1-9,11 {outfile1} > {outfile6}"
subprocess.run(generate_10C, shell=True, text=True)

print(" ")
print(" ======================================================================== ")
print(f"Starting STEP 3 for sample {sample}")
print(f"Generation of PGX input file from exome 10 columns file for sample {sample}")
print(" ")
...
# print(dfm.head(10))
dfm1 = dfm.drop(['0_y', '1_y', '3_y', '4_y', '5_y', '6_y', '7_y', '8_y'], axis=1)
...
dfm2['6_y'] = dfm2['9_y'].apply(categorize_value)
#
# print(dfm2.head(10))
#
...
print(" ")
print(" ======================================================================== ")
print(f"Starting STEP 4 for sample {sample}")
print(" ")

'''
Generation of PGX haplotype input file from exome 10 columns
'''
...
dfm1 = dfm.drop([0, 1, 2, 3, 4, 5, 6, 7, 8], axis=1)
...
# Create the new column '6' based on the values in column '5'
dfm2[6] = dfm2[9].apply(categorize_value)
