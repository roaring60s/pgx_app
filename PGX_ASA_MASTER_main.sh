...
# RUN 08-06-2026: MGRC
#/media/D1/patients/2026/MGRC_20260608/biodata/MGRC_20260608_biodata_master.txt
#/media/D1/patients/2026/MGRC_20260608/data_pgx/20260515_209971290012_V0_Hg37.txt
...
name="MGRC_20260608"  # => change e.g MGRC_batch, after 2024
run="MGRC_20260608"  # => change e.g MGRC_batch, after 2024
batch="MGRC_20260608"  # => change e.g MGRC_batch, after 2024

asa_run="20260612_209971290006"  # => change
asa1="20260612_209971290006_V0_Hg37_NONCLUSTER.txt"  # => change

report1="13_06_2026"  # => change
report2="13/06/2026"  # => change
...
bio_path=$biodatad$batch'B_biodata_master.txt'  # => change
...
hap_clin_alleles_EV13="$annd/pgx_asa_hap_clin_alleles_EV13_200925.txt"
...
time "$pythonbin" "$pythond/fnc_PGX_ST0C_select_samples_from_ASA_260625.py" "$bio_path" "$asa_out" "$dir_path"
wait
...
time "$pythonbin" "$pythond/fnc_pgx_select_snps4haps_step1A_12_12_24.py" "$bio_path" "$hap_snps_master" "$dir_path"
wait
...
time "$pythonbin" "$pythond/fnc_pgx_hap_allels_1B_12_12_24.py" "$bio_path" "$hap_alleles_master" "$dir_path"
wait
...
time "$pythonbin" "$pythond/fnc_pgx_select_snps4variants_step1_12_12_24.py" "$bio_path" "$variants_snps_master" "$dir_path"
wait
...
time "$pythonbin" "$pythond/fnc_pgx_hap_clin_ST3_220825.py" "$bio_path" "$hap_clin_alleles_EV13" "$dir_path"
wait
